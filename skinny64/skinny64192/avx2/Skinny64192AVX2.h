/*
Defintions and intrinsics used for the implementation of Skinny64/192.
*/

#ifndef SKINNY64192AVX2_H
#define SKINNY64192AVX2_H
#include "immintrin.h"

// Number of rounds for this SKINNY variant
#define NROUNDS 40
...
#define SWAPMOVE(a, b, mask, shift) do {            \
